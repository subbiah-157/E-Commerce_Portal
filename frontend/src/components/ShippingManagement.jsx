    ...
    const fetchOrders = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/orders/approved/shipping"
        );
      ...
      <div className="smc-content-wrapper">
        ...
        <div className="smc-main-content">
          <div className="smc-content-header">
            <h2>{filterStatus === 'completed' ? 'Completed Orders' : 'Incomplete Orders'}</h2>
...
// ✅ OrderCard
const OrderCard = ({ order, expandedOrders, expandedProducts, toggleOrderDetails, toggleProductDetails, handleMarkShipped, renderSize, renderProductImage, isCompleted }) => {
