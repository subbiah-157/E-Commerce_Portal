...
import { FaCheck, FaTimes, FaEdit, FaMoneyBillWave, FaCreditCard } from "react-icons/fa";
...
const OrderConfirmation = () => {
  ...
  const saveNewAddress = async () => {
    ...
    try {
      await axios.put(`http://localhost:5000/api/users/${user.id}`, userDetails, {
        headers: { Authorization: `Bearer ${user.token}` },
      });
    ...
    <div className="order-confirmation-container">
      ...
      <div className="section">
        ...
        <div className="address-display">
          <p>{userDetails.houseNumber ? userDetails.houseNumber + ", " : ""}{userDetails.region} {userDetails.district}, {userDetails.state} - {userDetails.pincode}</p>
          ...
          <div className="modal-overlay">
            <div className="modal">
              ...
              <div className="modal-actions">
                ...
                <button onClick={() => setShowAddressModal(false)} className="btn btn-danger">
                  <FaTimes /> Cancel
                </button>
              </div>
            </div>
